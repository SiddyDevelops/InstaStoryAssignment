package com.siddydevelops.instastoryassignment.progressBar
...
class MultiProgressBar @JvmOverloads constructor(
    ...
    private var progressColor = WHITE
    private var lineColor = Color.GRAY
    private var progressPadding = MIN_PADDING.toPx
    private var progressWidth = DEFAULT_WIDTH.toPx
    ...
    private var progressPercents: Int =100
